    ...
    >
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-[800px] text-center mb-16">
          ...
          <h2 className="font-serif font-bold text-3xl sm:text-4xl text-[#7A1F1F] tracking-wide uppercase mb-6">
            CHƯƠNG 7 - KẾT: NGUYÊN TẮC XÉT XỬ
          </h2>
          <p className="text-[#1B1B1F] text-justify sm:text-center text-base sm:text-lg leading-relaxed font-normal">
        ...
        <div className="w-full mb-16">
          <h3 className="font-serif font-bold text-xl sm:text-2xl text-[#1B1B1F] text-center uppercase tracking-wide mb-8 border-b border-[#1B1B1F] pb-3">
          ...
          <div className="flex flex-col md:flex-row gap-8 w-full">
            ...
            <div className="flex-1 bg-transparent border-2 border-[#7A1F1F] p-6 sm:p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="text-[#1B1B1F] text-justify text-sm sm:text-base leading-relaxed mb-8">
              ...
              <div className="font-mono font-bold text-xl sm:text-2xl text-[#7A1F1F] border-t border-[#7A1F1F] pt-4 tracking-tight">
                11 ÁN TỬ HÌNH - 18 ÁN CHUNG THÂN
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full">
            ...
            <div className="bg-[#F9F7F1] border border-[#1B1B1F] p-6 flex flex-col justify-between">
              <div>
                ...
                <h4 className="font-serif font-bold text-lg text-[#1B1B1F] uppercase border-b border-[#1B1B1F] pb-2 mb-3">
                  Phần lớn bị cáo
                </h4>
                <p className="text-sm text-[#1B1B1F] leading-relaxed text-justify">
            ...
            <div className="bg-[#1B1B1F] border border-[#1B1B1F] p-6 text-white flex flex-col justify-between">
              <div>
                ...
                <h4 className="font-serif font-bold text-lg text-white uppercase border-b border-white/30 pb-2 mb-3">
                  Vũ Hải Anh
                </h4>
